...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        colAutor.setMaxWidth(Integer.MAX_VALUE * 25d);
        colEditora.setMaxWidth(Integer.MAX_VALUE * 20d);
        colStatus.setMaxWidth(Integer.MAX_VALUE * 10d);
        colPaginas.setMaxWidth(Integer.MAX_VALUE * 10d);
